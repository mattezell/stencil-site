...
Notice that the `value` property is not displayed in as an attribute, however it does not mean it's not there, the `value` property still contains the `The meaning of life...` value:
